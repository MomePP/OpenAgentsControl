...
if curl -fsSL --max-time 5 https://raw.githubusercontent.com/MomePP/OpenAgentsControl/main/README.md > /dev/null 2>&1; then
...
echo "  curl -fsSL https://raw.githubusercontent.com/MomePP/OpenAgentsControl/main/install.sh | bash"
echo ""
